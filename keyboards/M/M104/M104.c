...
void bootmagic_lite(void)
{
	...
	// If the BOOTMAGIC_LITE key is held down on power up,
...
void led_set_kb(uint8_t usb_led)
{
  ...
  switch (layer_state) 
	{
		case 2:       rgblight_sethsv_at( 64, 255, 10,0); break;  // HSV_CHARTREUSE    64, 255, 255
		case 4:       rgblight_sethsv_at(132, 102, 10,0); break;  // HSV_AZURE        132, 102, 255
		case 8:       rgblight_sethsv_at(213, 255, 10,0); break;  // HSV_MAGENTA      213, 255, 255
		default:        
			if (usb_led & (1<<USB_LED_SCROLL_LOCK)) {
				//rgblight_setrgb_at(0,10,0,0);
				rgblight_sethsv_at(30,255,20,0);  // HSV_GOLDENROD     30, 218, 218
  		} else {
  ...
  if (usb_led & (1<<USB_LED_NUM_LOCK)) {
				rgblight_sethsv_at(30, 255, 20,2);  // HSV_GOLDENROD     30, 218, 218
  } else {
		rgblight_setrgb_at(0,0,0,2);
  }
  if (usb_led & (1<<USB_LED_CAPS_LOCK)) {
				rgblight_sethsv_at(30, 255, 20,1);  // HSV_GOLDENROD     30, 218, 218
  } else {
